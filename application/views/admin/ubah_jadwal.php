							...
							<div class="m-portlet__body">
								<div class="tab-content">
									<div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
										<form class="m-form m-form--fit m-form--label-align-right" id="ubahJadwal">	
												...
												<div class="col-xl-10 col-lg-10">
													<select class="form-control m-select2" name="khotbah" id="anggota" style="width:100%;">
                                                        ...
                                                        <?php foreach($anggota_jemaat as $row) { ?>
                                                            <option value="<?php echo $row->nama_anggota; ?>" <?php selected($jadwal->khotbah, $row->nama_anggota) ?>><?php echo $row->nama_anggota; ?></option>
                                                        <?php } ?>
													</select>
													<div class="m--font-danger ml_input_eh set_error" id="khotbah"></div>
												</div>
                                                <input type="hidden" name="id" value="<?php echo $jadwal->id_jadwal; ?>">
                                                <input type="hidden" name="okhotbah" value="<?php echo $jadwal->khotbah; ?>">
                                                <input type="hidden" name="otanggal" value="<?php echo $jadwal->tanggal; ?>">
                                                <input type="hidden" name="owaktu_m" value="<?php echo $jadwal->waktu_mulai; ?>">
                                                <input type="hidden" name="owaktu_s" value="<?php echo $jadwal->waktu_selesai; ?>">
											</div>
															
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Tanggal</label>
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="date" autocomplete="off" name="tanggal" placeholder="tanggal ibadah" value="<?php echo $jadwal->tanggal; ?>">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="time" autocomplete="off" name="waktu_m" placeholder="waktu ibadah" value="<?php echo $jadwal->waktu_mulai; ?>">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="time" autocomplete="off" name="waktu_s" placeholder="waktu ibadah" value="<?php echo $jadwal->waktu_selesai; ?>">
													<div class="m--font-danger ml_input_eh set_error" id="waktu_s"></div>
												</div>
											</div>

											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">Jenis ibadah</label>
												<div class="col-xl-10 col-lg-10">
                                                    <select class="form-control" name="ibadah" style="width:100%;">
                                                        <option value="" <?php selected($jadwal->tipe_ibadah, ''); ?>>--- Pilih jenis ibadah ---</option>
                                                        <option value="Ibadah Gereja" <?php selected($jadwal->tipe_ibadah, 'Ibadah Gereja'); ?>>Ibadah Gereja</option>
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<textarea class="form-control m-input" type="text" autocomplete="off" name="catatan" placeholder="catatan"><?php echo $jadwal->catatan; ?></textarea>
