						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item m-nav__item--home">
										<a href="admin/warta-jemaat" class="m-nav__link">
											<span class="m-nav__link-text">Daftar warta / buletin</span>									
										</a>
									</li>
								</ul>
							</div>
							...
							<div class="m-portlet__body">
								<div class="tab-content">
									<div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
										<form class="m-form m-form--fit m-form--label-align-right" id="tambahWartaJemaat" enctype="multipart/form-data">
											<div class="form-group m-form__group row">
												<label class="col-xl-2 col-lg-2 col-form-label">PDF File</label>
												<div class="col-xl-10 col-lg-10">
													<div class="custom-file">
														<input type="file" class="custom-file-input" name="pdf_file">
														<label class="custom-file-label" for="customFile">Pilih PDF file</label>
														<div class="m--font-danger ml_input_eh set_error" id="pdf_file"></div>
													</div>
												</div>
                                            </div>
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<input class="form-control m-input" type="date" autocomplete="off" name="tanggal" placeholder="tanggal">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-xl-10 col-lg-10">
													<textarea class="form-control m-input" type="text" autocomplete="off" name="ket" placeholder="keterangan"></textarea>
