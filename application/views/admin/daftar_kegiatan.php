												...
												<tbody>
													...
													foreach($kegiatan as $row)
													{
														...
														<tr>
															<td><?php echo $no; ?></td>
															<td>
																<a href="admin/ubah-kegiatan/<?php echo $id_kegiatan; ?>" data-skin="dark" data-toggle="m-tooltip" data-placement="top" title="Lihat">
																	<?php echo set_data($jenis_kegiatan); ?>
																</a>
															</td>
															...
															<td>
																<a href="admin/delete-kegiatan/<?php echo $id_kegiatan; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill">
