											...
											<table class="table m-table m-table--head-bg-success" id="m_table_1">
												...
												<tbody>
													...
													foreach($warta_jemaat as $row)
													{
														...
														<tr>
															<td><?php echo $no; ?></td>
															<td><?php echo set_data($file); ?></td>
															<td><?php echo $tanggal; ?></td>
															<td><?php echo set_data($keterangan); ?></td>
															<td>
																<a href="admin/delete-warta-jemaat/<?php echo $id_wj; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill">
