<?php
    ...
    class Tambah_renungan extends ML_Controller
    {
        ...
        public function index()
        {
            ...
            if($this->form->validate())
            {
                ...
                # insert new data kpp
                $this->model->data('judul', $judul_renungan)
                            ->data('ayat', $ayat_renungan)
                            ->data('ringkasan', $ringkasan)
                            ->data('tanggal', $tgl_renungan)
                            ->insert('renungan');
                
                $this->model->close_conn();
                exit('1|Berhasil tambah renungan.');
            }
            else
            {
