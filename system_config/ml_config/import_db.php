<?php
    ...
    to('html', 'lang::en');
        to('head');
            title('ApiLine.ml | Configuration | Import Database');
                ...
                to('section', 'class::wy-nav-content-wrap');
                    to('div', 'class::wy-nav-content');
                        to('div' ,'class::head-nav role::navigation');
                            to('a', 'class::link*docs href::configuration'.$this->ml_config_uri).show('MadeLine Configuration &nbsp;').tc('a') .' '. arrow().show('&nbsp; Import Database');
                        tc('div');
                        ul();                    
                        to('div', 'id::content-holder');                    
                            to('form', 'class::import_db ajax::1');
                                to('table', 'class::ml-table');
                                    to('tr', 'class::bb');
                                        to('td', 'class::td-table').show('Choose File.sql').tc('td');
                                        to('td');
                                            make('input', '', 'type::file class::ML-input-full*ML-rounded*ML-border-gray*db_file name::db_file').
                                        tc('td');
                                    tc('tr');
                                    to('tr');
                                        to('td', 'class::td-table').tc('td');
                                        to('td');
                                            to('button', 'class::ganti_password*db_con').show('Import Database').tc('button');
                                        tc('td');
                                    tc('tr');                                
                                tc('table');
                            tc('form');                        
